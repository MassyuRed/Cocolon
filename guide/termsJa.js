export const guideTermsJa = Object.freeze({
  ...
  friend_notifications: {
    ...
    display: "フレンドに通知しない",
    reading: "フレンドにつうちしない",
    shortDef: "感情入力をフレンドに共有しないための設定です。",
    longDef:
      "この設定をオンにすると、その入力はフレンド側へ通知されません。フレンド機能を使いつつ、入力ごとに共有の濃さを自分で調整したいときに便利です。",
    examples: [
  ...
  friend: {
    ...
    display: "フレンド",
    reading: "フレンド",
    shortDef: "感情の流れを共有できる相手とのつながりです。",
    longDef:
      "Cocolon におけるフレンドは、相手の感情入力の変化を受け取れる関係です。言葉をたくさん交わさなくても、感情のレベルで近況を知るための設計になっています。",
    examples: [
      "身近な人の感情の流れを見守る",
      "気持ちの変化を非言語で受け取る",
    ],
  ...
  friend_log: {
    ...
    display: "フレンドログ",
    reading: "フレンドログ",
    shortDef: "フレンドの感情入力の流れを確認するための一覧です。",
    longDef:
      "フレンドがどんな感情を入力していたかを時系列で見ていくための場所です。メモ本文を読むというより、感情の波を受け取ることに重心があります。",
    examples: [
      "最近の相手の気持ちの流れを見る",
