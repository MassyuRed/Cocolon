export const guideTermsJa = Object.freeze({
  ...
  analysis_report: {
    ...
    longDef:
      "感情入力や内容カテゴリの蓄積をもとに、自分の傾向や流れを読み解くためのレポートです。分析画面では、こころ天気（日/週/月）や自己分析として確認できます。",
    examples: [
      "最近の感情の偏りをつかむ",
  ...
  analysis: {
    ...
    longDef:
      "Home で行った入力をあとから整理し、こころ天気（日/週/月）・自己分析として確認する場所です。最新レポートを画面内で読み、必要に応じて履歴へ進めます。",
    examples: [
      "今週の感情分析を読む",
      "自己分析の履歴を確認する",
    ],
