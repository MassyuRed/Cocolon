...
const PROGRAM_RELATIVE_PATH = 'v16_retry2_draft/v16_public_gate_execution_continuation_carrier_v3_transformer_v4_preparation_orchestrator_v3.js';
...
const ORCHESTRATOR_V2_BYTES = 23623;
const ORCHESTRATOR_V2_LF = 567;
const ORCHESTRATOR_V2_SHA256 = '3b6533b9276190a3fb5bd92c7af1003d078dfff252f4941c4a677c6d7197a89a';
...
function validateTargetParentPhysicalPath(root, targetAbsolute) {
...
function validatorLiteralHasExactCountRole(text, literal) {
  ...
  return validatorControl && countEquality;
}
...
function deriveT06Marker(definition, outside) {
  ...
  ensure(validatorLiteralHasExactCountRole(outside, literal));
  return marker;
}
...
function buildT06Value(marker, futureAuthorityBytes, futureAuthoritySha, programBytes, programSha) {
  ...
  const groups = [
    ...
    'D04_PRIOR_V23_PREPARATION_AUTHORITY_ASCII_BYTES_' + String(V23_ASCII_BYTES) + '_SHA256_' + V23_SHA256.toUpperCase() + '_APPROVED_ACTIVATED_CONSUMED_CLOSED_SINGLE_USE_EXACT1_ORCHESTRATOR_V1_RELATIVE_PATH_V16_RETRY2_DRAFT_SLASH_V16_PUBLIC_GATE_EXECUTION_CONTINUATION_CARRIER_V3_TRANSFORMER_V4_PREPARATION_ORCHESTRATOR_V1_DOT_JS_RAW_BYTES_' + String(ORCHESTRATOR_V1_BYTES) + '_LF_' + String(ORCHESTRATOR_V1_LF) + '_CR_EXACT0_FINAL_LF_TRUE_SHA256_' + ORCHESTRATOR_V1_SHA256.toUpperCase() + '_EXACT_NEW_CREATE_WRITE_CLOSE_FREEZE_EXACT1_EACH_STATIC_REVIEW_ATTEMPT_EXACT4_PASS_EXACT0_INVALID_EXACT4_BLOCKER_STOP_EXACT1_FROZEN_UNCHANGED_INACTIVE_NONCREDIT_UNPUBLISHED_EXACT1_EACH_REUSE_REACTIVATION_RECONSUMPTION_REEXECUTION_RETRY_RETROACTIVE_CREDIT_EXACT0_EACH_PRIOR_V27_PREPARATION_AUTHORITY_ASCII_BYTES_' + String(V27_ASCII_BYTES) + '_SHA256_' + V27_SHA256.toUpperCase() + '_APPROVED_ACTIVATED_CONSUMED_CLOSED_SINGLE_USE_EXACT1_ORCHESTRATOR_V2_RELATIVE_PATH_V16_RETRY2_DRAFT_SLASH_V16_PUBLIC_GATE_EXECUTION_CONTINUATION_CARRIER_V3_TRANSFORMER_V4_PREPARATION_ORCHESTRATOR_V2_DOT_JS_RAW_BYTES_' + String(ORCHESTRATOR_V2_BYTES) + '_LF_' + String(ORCHESTRATOR_V2_LF) + '_CR_EXACT0_FINAL_LF_TRUE_SHA256_' + ORCHESTRATOR_V2_SHA256.toUpperCase() + '_EXACT_NEW_CREATE_WRITE_CLOSE_FREEZE_EXACT1_EACH_STATIC_REVIEW_ATTEMPT_EXACT4_PASS_EXACT1_INVALID_EXACT3_BLOCKER_EXACT2_B01_T06_DIRECT_EQUALITY_ROLE_ACCEPTED_BUT_APPEND_TRANSFORM_MAKES_DIRECT_EQUALITY_FALSE_EXACT1_B02_SOURCE_AND_TARGET_PARENT_REALPATH_GATES_NOT_IMMEDIATELY_ADJACENT_TO_SOURCE_OPEN_AND_TARGET_LSTAT_EXACT1_FROZEN_UNCHANGED_INACTIVE_NONCREDIT_UNPUBLISHED_EXACT1_EACH_EXECUTION_NODE_SYNTAX_IMPORT_REQUIRE_EVALUATION_REUSE_REACTIVATION_RECONSUMPTION_REEXECUTION_RETRY_RETROACTIVE_CREDIT_EXACT0_EACH_CURRENT_NATURAL_LANGUAGE_ORCHESTRATOR_V3_BOUNDED_CORRECTION_PREPARATION_AUTHORITY_DISTINCT_FROM_V27_EXACT1_APPROVED_ACTIVATED_CONSUMED_CLOSED_SINGLE_USE_EXACT1_ORCHESTRATOR_V3_RELATIVE_PATH_V16_RETRY2_DRAFT_SLASH_V16_PUBLIC_GATE_EXECUTION_CONTINUATION_CARRIER_V3_TRANSFORMER_V4_PREPARATION_ORCHESTRATOR_V3_DOT_JS_RAW_BYTES_' + String(programBytes) + '_SHA256_' + programSha.toUpperCase() + '_EXACT_NEW_CREATE_WRITE_CLOSE_FREEZE_EXACT1_EACH_STATIC_REVIEW_ATTEMPT_EXACT4_PASS_EXACT4_INVALID_EXACT0_RECORDED_ONLY_DURING_FUTURE_EXECUTION_AFTER_COMPLETED_REVIEW_GATE_EXACT1_EXECUTION_NODE_SYNTAX_IMPORT_REQUIRE_EVALUATION_EXACT0_EACH_REACTIVATION_RECONSUMPTION_REEXECUTION_RETRY_EXACT0_EACH',
...
function main() {
  ...
  validateTargetParentPhysicalPath(root, targetAbsolute);
