...
export const IAP_TRIAL_OFFER_TAGS = Object.freeze({
  android: {
    plus:
      readEnv("EXPO_PUBLIC_IAP_PLUS_TRIAL_OFFER_TAG_ANDROID") ||
      "trial_1m_new_user",
  },
});
...
export function getSubscriptionPublicAudit() {
  ...
  if (!PUBLIC_RUNTIME_CONFIG.termsUrl) {
    blockingIssues.push("EXPO_PUBLIC_TERMS_URL が未設定です。");
  }
  if (!PUBLIC_RUNTIME_CONFIG.privacyUrl) {
    blockingIssues.push("EXPO_PUBLIC_PRIVACY_URL が未設定です。");
  }
