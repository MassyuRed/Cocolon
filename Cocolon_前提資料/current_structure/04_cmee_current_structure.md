...
current_authorized_next_work: "EMLIS_Q4_INTEGRATION_VERIFIED_BODY_QUALITY_FOLLOWUP"
...
Current state:
    ...
    detailed implementation route = canonical 02 Q1 section / 05 Emlis thread v1 profile / 06 Q1 order; latest existing runtime handoff
    ...
    current authorized next work = SOURCE_VERIFIED_FEELING_AND_EXISTING_ACTION_SELECTION_REPAIR_PER_CANONICAL_02
...
新しい意味carrier・selector・schemaは追加せず、既存ObservationPlanのsource proofと同じpure形態関数、Human Receptionの原文確認済み参照だけを更新。V1／public／国家／Piece／Analysisのowner境界は維持する。
