...
decision_level: LEVEL_3_METHOD_OR_PRODUCT_QUALITY_CHANGE
scope: "EmlisAI Stage 1 / Layer 1『見えたこと』+ Layer 2『Emlisから』"
decision_owner: Mash
...
```mermaid
flowchart TD
    A["既存 source / meaning / safety"] --> B["Layer 1 semantic core"]
    B --> C["Emlis subjective meaning"]
    C --> D["Frozen projection + discourse plan"]
    D --> E["Grounded candidates + normal form"]
    E --> F["Layer 1 / Layer 2 actual text"]
```
