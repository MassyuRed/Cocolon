...
Current execution state: `BLOCKED_AVAILABILITY_CONSTRAINT_UNFINISHED`. Execution and next checkpoint are owned by canonical 06 §89 and the existing mashos-api handoff.
