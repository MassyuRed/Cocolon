...
| レポートこころ天気図 | レポート内天気図 / 詳細Modal | `AnalysisReportViewerScreen.js`, `KokoroWeatherForecastStrip.js`, `KokoroWeatherDetailModal.js`, `kokoroWeatherFormatters.js` | `content_json.kokoroWeather` | content_jsonのadditive payload。古いレポートでは存在しないことが正常 |
