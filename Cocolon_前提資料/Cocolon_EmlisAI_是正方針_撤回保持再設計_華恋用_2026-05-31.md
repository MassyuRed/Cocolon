...
```text
Cocolon_前提資料/Cocolon_思想資料_華恋用.md
Cocolon_前提資料/Cocolon_作業姿勢とルール_華恋用/00_READ_FIRST_最初に読む.txt
Cocolon_前提資料/Cocolon_作業姿勢とルール_華恋用/05_禁止事項_勝手な補完と構造追加.txt
Cocolon_前提資料/Cocolon_作業姿勢とルール_華恋用/99_統合版_毎回貼る用.txt
...
`Cocolon_思想資料_華恋用.md` では、Cocolonは画面・API・DB・AI応答の集合ではなく、ユーザーの自己情報・他者情報・感情・思考・役割・言葉の箱詰め工程を観測する構造であると定義されている。

確認箇所:

```text
Cocolon_思想資料_華恋用.md:16-17
Cocolon_思想資料_華恋用.md:21-24
Cocolon_思想資料_華恋用.md:29
```
...
`Cocolon_思想資料_華恋用.md` では、EmlisAIは以下のように定義されている。

確認箇所:

```text
Cocolon_思想資料_華恋用.md:111
Cocolon_思想資料_華恋用.md:122-126
Cocolon_思想資料_華恋用.md:179-196
```
...
`Cocolon_思想資料_華恋用.md` では、低情報入力についても、EmlisAIは無理に深く観測してはいけないが、返答自体はEmlisの観測として扱うとされている。

確認箇所:

```text
Cocolon_思想資料_華恋用.md:803-819
```
...
`Cocolon_思想資料_華恋用.md` では、テンプレはユーザーの箱詰め工程を見ずに、それっぽい返答を返す構造であり、Cocolon体験を壊すとされている。

確認箇所:

```text
Cocolon_思想資料_華恋用.md:431-458
Cocolon_思想資料_華恋用.md:780-801
```
...
`Cocolon_作業姿勢とルール_華恋用/00_READ_FIRST_最初に読む.txt` では、確認していないものを確認したように言わない、前提資料・実ファイル・ログを確認できない状態でCocolon判断を出さない、事実と推測を分ける、というルールがある。

確認箇所:

```text
00_READ_FIRST_最初に読む.txt:8-17
00_READ_FIRST_最初に読む.txt:21-28
00_READ_FIRST_最初に読む.txt:32-44
00_READ_FIRST_最初に読む.txt:58-66
```

`05_禁止事項_勝手な補完と構造追加.txt` には、以下が明記されている。

確認箇所:

```text
05_禁止事項_勝手な補完と構造追加.txt:24-38
05_禁止事項_勝手な補完と構造追加.txt:43-48
```
...
`Cocolon_EmlisAI_状態回答と人間的フォロー_設計定義_華恋用_2026-05-26.md` では、EmlisAIが返すべきものは行動指示ではなく、今の自分がどんな環境で、どんな状態になり、何を出力しているのかの状態回答だとされている。
