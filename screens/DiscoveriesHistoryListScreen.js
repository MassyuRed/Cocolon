...
const DISCOVERIES_REFLECTIONS_ENDPOINT = `${API_BASE}/mymodel/qna/discoveries/reflections`;
...
export default function DiscoveriesHistoryListScreen({ navigation }) {
  ...
  const fetchPage = useCallback(async ({ nextOrder, nextOffset, append }) => {
    ...
    const url = `${DISCOVERIES_REFLECTIONS_ENDPOINT}?order=${encodeURIComponent(
      resolvedOrder
