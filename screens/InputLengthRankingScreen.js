...
export default function InputLengthRankingScreen({ navigation }) {
  ...
  const load = useCallback(async () => {
    ...
    setError("");
    try {
      const url = new URL("/ranking/input_length", API_BASE);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <RankingHeader styles={styles} title="入力文字数ランキング" navigation={navigation} />
