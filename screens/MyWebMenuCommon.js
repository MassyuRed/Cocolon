...
export function useMyWebMenuStyles() {
...
export function MyWebMenuScroll({ children, scrollRef, onScroll }) {
...
export function MyWebSubHeader({ title, onBack }) {
...
export function MyWebDescription({ children }) {
  const { styles } = useMyWebMenuStyles();

  return <Text style={styles.descriptionText}>{children}</Text>;
}

export function MyWebLargeCard({
  title,
  description,
  updateLabel,
  onPress,
...
export function MyWebMediumCard({
  title,
  description,
  onPress,
  badgeVisible = false,
...
export function MyWebOptionRow({
  label,
  meta,
  onPress,
  badgeVisible = false,
